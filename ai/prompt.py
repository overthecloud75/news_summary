...
보안 위협 동향 보고서 : [제목 입력]
보고서의 주요 대상은 [보고서 대상 (예: 기업 경영진, 보안 담당자)]입니다.
보고서에는 작성일 및 대상(예: 기업 경영진, 보안 담당자) 정보는 포함하지 마세요.
...
REPORT = '''### 보고서 작성 지침
보고서 : [제목 입력]
보고서의 주요 대상은 [보고서 대상 (예: 기업 경영진, IT 관리자, 보안 담당자)]입니다.
...
보고서의 맨 앞에 "보고서 : [제목]" 형식의 제목을 삽입하세요.
작성일과 보고서 대상 정보는 포함하지 마세요.
문서의 핵심 내용을 정확히 반영하며, 필요한 경우 문서의 일부를 인용하세요.
명확하고 간결한 언어를 사용하세요.
...
REVISED_REPORT_PROMPT = '''제공된 보고서의 내용을 다음 기준에 따라 명확하고 간결하게 개선해줘:

1. 핵심 내용을 구조화하여 **논리적 흐름**에 따라 재정리하고, 불필요한 표현은 제거해.
2. 내용이 효과적으로 전달될 수 있도록 **목록화, 항목 정리**를 통해 가독성을 높여줘.
3. 문맥상 중요한 개념이나 **용어**가 등장할 경우, 그것이 의미하는 바를 다른 사람이 이해할 수 있도록 **명확한 정의 또는 설명**을 추가해.
4. 보고서의 끝에는 핵심 **결론이나 시사점**을 포함해.
5. 최종 결과물에는 개선된 보고서 내용만 포함되며, "개선본"과 같은 구분 문구나 원본 내용은 포함하지 않아.

보고서 원문:
{}
'''

REVISED_REPORT_PROMPT_WITHOUT_REPORT = '''제공된 보고서의 내용을 다음 기준에 따라 명확하고 간결하게 개선해줘:

1. 핵심 내용을 구조화하여 **논리적 흐름**에 따라 재정리하고, 불필요한 표현은 제거해.
2. 내용이 효과적으로 전달될 수 있도록 **목록화, 항목 정리**를 통해 가독성을 높여줘.
3. 문맥상 중요한 개념이나 **전문 용어**가 등장할 경우, 그것이 의미하는 바를 다른 사람이 이해할 수 있도록 **명확한 정의 또는 설명**을 추가해.
4. 보고서의 끝에는 핵심 **결론이나 시사점**을 포함해.
5. 최종 결과물에는 개선된 보고서 내용만 포함되며, "개선본"과 같은 구분 문구나 원본 내용은 포함하지 않아.
'''
